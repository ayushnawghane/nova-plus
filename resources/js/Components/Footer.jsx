                    ...
                    <div className="lg:col-span-2 grid grid-cols-2 gap-10 pt-1">
                        ...
                        <div>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                {[
                                    { name: 'ESG Consulting', href: route('services') },
                                    { name: 'Carbon Accounting & Net Zero', href: route('services') },
                                    { name: 'Corporate Training', href: route('services.corporate-training') },
                                    { name: 'ESG Insights', href: route('insights') }
                                ].map((item) => (
                                    <li key={item.name}>
                                        <Link href={item.href} style={linkStyle} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>{item.name}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                {[
                                    { name: 'Why Nova Plus', href: route('home') },
